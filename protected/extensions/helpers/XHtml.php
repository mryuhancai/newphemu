...
class XHtml extends CHtml
{
	...
	public static function imageUrl($filename)
	{
  	...
  	public static function upfileUrl($filename)
	{
		return Yii::app()->baseUrl.'/upfile/'.$filename;
	}
	public static function removeupfileUrl($filename)
	{
		return Yii::app()->baseUrl.'/'.$filename;
	}
