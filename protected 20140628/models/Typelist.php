...
// 		    'typeid' => array(self::HAS_MANY, 'DocumentContent', 'did'),
			'dtid' => array(self::HAS_MANY, 'Document', 'tid'),
			'dctid' => array(self::HAS_ONE, 'documentcontent', 'did'),
		...
		if($this->linkid>0)
			{
				...
				return array('site/view','tid'=>$this->tid,'typename'=>$this->typename,'topid'=>$this->topid,'islink'=>false);
			}
	}
